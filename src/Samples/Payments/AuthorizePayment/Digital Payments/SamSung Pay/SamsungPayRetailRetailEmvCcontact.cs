...
namespace Cybersource_rest_samples_dotnet.Samples.Payments.AuthorizePayment.Digital_Payments.SamSung_Pay
{
    public class SamsungPayRetailRetailEmvCcontact
    {
